...
import com.example.quizmania.databinding.ActivityQuizBinding
import com.example.quizmania.databinding.ScoreDialogBinding
...
class QuizActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(view: View?) {
     ...
     // which button is clicked
        ...
        if (clickedBtn.id==R.id.btn_next)
        {
            ...
            // options buttons is clicked
            // whenever the option is selected we can store the answer
    ...
    private fun finishQuiz()
    {
     ...
     dialogBinding.apply {
         ...
         scoreProgressTest.text = "$percentage %"
         if (percentage>60)
         {
